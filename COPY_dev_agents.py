...
class PlayerAgent:
    ...
    def set_up_task(self, task_id, s_shape, a_shape):
        ...
        print("self.a_shape:")
        print(self.a_shape)
        print("self.max_s_shape:")
        print(self.max_s_shape)
        print("self.max_a_shape:")
        print(self.max_a_shape)
    ...
    def proto_criterion(self, outputs, targets, masks):
        ...
        #task_comp = s_factor*a_factor
        # notes:
        # - log7.5 did NOT work
        # - log5 did work
        # - ln did work <- pref this for simplicity and intuitiveness
        #task_comp = np.log10(7.5*(s_factor*a_factor)+1)
        #task_comp = np.log10(5*(s_factor*a_factor)+1)
