...
class DataHandler:
    ...
    def store_train_data(self, data, task_id):
        ...
        run_val, r_val, time_val = data

        if task_id not in self.num_runs:
    ...
    def save_train_data(self, task, task_id):
        ...
        data_dict = {'runs': self.num_runs[task_id], 'r': self.r_data[task_id], 'time': self.num_time[task_id]}
    ...
    def store_test_data(self, data, task_id):
        ...
        if task_id not in self.test_num_runs:
    ...
    def save_test_data(self, task, task_id, iteration):
        ...
        data_dict = {'runs': self.test_num_runs[task_id], 'r': self.test_r_data[task_id], 'time': self.test_num_time[task_id]}
