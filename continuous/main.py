...
# tasks
available_tasks = ["Pendulum-v0", "MountainCarContinuous-v0", "BipedalWalker-v3"]
...
run_lim_dict = {available_tasks[0]: 30000, available_tasks[1]: 30000, available_tasks[2]: 50000}
...
def main():
    ...
    agent = agents.PlayerAgent(gamma, critic_alpha, actor_alpha, seed_val, mem_len_dict, epsilon, epsilon_decay, epsilon_min, smax, c_lamb, a_lamb, thresh_emb, thresh_cosh, clipgrad)
    if load_models:
        agent.load()
