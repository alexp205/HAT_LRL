...
#run_lim_dict = {available_tasks[0]: 50000, available_tasks[1]: 5000, available_tasks[2]: 5000}
test_run_lim_dict = {available_tasks[0]: 10000, available_tasks[1]: 10000, available_tasks[2]: 10000}
#test_run_lim_dict = {available_tasks[0]: 10, available_tasks[1]: 30, available_tasks[2]: 30}
...
def main():
    ...
    if not is_demo:
        ...
        for idx, task in enumerate(task_arr):
            ...
            for seen_task in seen_task_dict:
                agent.check_forgetting(seen_task, seen_task_dict[seen_task])
